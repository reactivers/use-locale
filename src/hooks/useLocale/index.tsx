...
function createLocale<T>() {
    ...
    const LocaleContext = createContext({} as LocaleContextProps<T>);

    const LocaleProvider: FC<LocaleProviderProps<T>> = ({ locales, activeLanguage: _activeLanguage, defaultLanguage = "en-us", children }) => {
